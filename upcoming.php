...
<html lang="en">
    <head>
        ...
        <title>ZaboR | Upcoming events</title>
    ...
    <body>
        <?php include "navbar.php"; ?>
            ...
            <div>
                <h1 class="animate-text">UPCOMING EVENTS</h1>
            </div>
            <div>
                <ol class="rectangle">
                    <li><a href="#">H O L I D A Y S <span class="date">04.06.24 - 00.09.24</span></a></li>
                    <li><a href="#">none<span class="date">00.00.00</span></a></li>
                    <li><a href="#">none<span class="date">00.00.00</span></a></li>
                  </ol>
            </div>
        <div class="conteiner">
